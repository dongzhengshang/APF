...
public class RoundedImageView extends android.support.v7.widget.AppCompatImageView {
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView_r_corner_radius, -1);
    borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_r_border_width, -1);
    ...
    borderColor = a.getColorStateList(R.styleable.RoundedImageView_r_border_color);
    if (borderColor == null) {
      borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
    }

    mutateBackground = a.getBoolean(R.styleable.RoundedImageView_r_mutate_background, false);
    isOval = a.getBoolean(R.styleable.RoundedImageView_r_oval, false);
