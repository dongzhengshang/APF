...
public class ProjectControl {
     ...
     */
    private void getData(String taskId, String url, Map<String, Object> params, String[] keys, Upload[] uploads, HttpUtils.HttpType httpType, boolean saveCache, boolean reflsh, AsyncTaskUtils.OnNetReturnListener... netReturnListeners) {
    ...
    protected void getDataByGet(String taskId, String url, Map<String, Object> params, AsyncTaskUtils.OnNetReturnListener... netReturnListeners) {
        getData(taskId, url, params, null, null, HttpUtils.HttpType.Get, false, true, netReturnListeners);
    }
    ...
    protected void getDataByJson(String taskId, String url, Map<String, Object> params, AsyncTaskUtils.OnNetReturnListener... netReturnListeners) {
        getData(taskId, url, params, null, null, HttpUtils.HttpType.Json, false, true, netReturnListeners);
    }
    ...
    protected void getDataByForm(String taskId, String url, Map<String, Object> params, AsyncTaskUtils.OnNetReturnListener... netReturnListeners) {
        getData(taskId, url, params, null, null, HttpUtils.HttpType.Form, false, true, netReturnListeners);
    }
    ...
    protected void Upload(String taskId, String url, Map<String, Object> params, Upload[] uploads, AsyncTaskUtils.OnNetReturnListener... netReturnListeners) {
        getData(taskId, url, params, null, uploads, HttpUtils.HttpType.Form, false, true, netReturnListeners);
    }
